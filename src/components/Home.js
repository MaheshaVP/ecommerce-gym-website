              ...
              <div className="testimonial">
                ...
                <div className="detail">
                  <div className="img_box">
                    <img
                      src="../ecommerce-gym-website/images//indexlogo.png"
                      alt="Testimonial"
                    />
                  </div>
                  <div className="info">
                    ...
                    <p>
                      Build muscle, increase endurance, and enhance overall
                      fitness with targeted strength exercises.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="banners">
        <div className="container">
          <div className="left_box">
            <div className="box">
              <img
                src="../ecommerce-gym-website/images//multiple-home-banner11.jpg"
                alt="Banner"
              />
            </div>
            <div className="box">
          ...
          <div className="right_box">
            ...
            <div className="bottom">
              <img
                src="../ecommerce-gym-website/images//multiple-home-banner5.jpg"
                alt="Banner"
              />
            </div>
          </div>
