        ...
        <div className='product_detail'>
          ...
          <div className='container'>
            ...
            <div className='info'>
              <h4>{detail.cat}</h4>
              <h2>{detail.Name}</h2>
              <p>Transform your home into a fitness haven: purchase this durable and versatile gym equipment and achieve your health goals with the convenience and flexibility of your own personal gym.</p>
